        ...
        <div className="container px-4 md:px-6 max-w-5xl mx-auto">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="mx-auto lg:mx-0 relative">
              {/* Efecto de brillo modificado para no interferir con la interactividad */}
              <div
                className="absolute inset-0 bg-gradient-to-r from-orange-400 to-red-500 rounded-xl blur-xl opacity-20 animate-pulse pointer-events-none"
                style={{ zIndex: 0 }}
              />
              {/* Aseguramos que la tarjeta esté por encima del efecto de brillo */}
